...
class TestDice(unittest.TestCase):
    def setUp(self):
        ...
        self.three_dice_1_2_3 = [dice.DICE_ART[1], dice.DICE_ART[2], dice.DICE_ART[3]]
    ...
    def test_generate_dice_faces_rows(self):
        ...
        self.assertEqual(dice._generate_dice_faces_rows(self.single_die_1), expected_single)
        ...
        self.assertEqual(dice._generate_dice_faces_rows(self.two_dice_1_2), expected_two)
    ...
    def test_generate_dice_faces_diagram(self):
        ...
        expected_rows = dice._generate_dice_faces_rows(self.three_dice_1_2_3)
